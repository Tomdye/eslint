...
module.exports = function(context) {
    var always = (context.options[0] !== "never"),
        ...
        tokensAndComments = sourceCode.tokensAndComments,
        tokenStore = new TokenStore(tokensAndComments);
    ...
    function checkSpacingInsideBraces(node) {
        ...
        var firstToken = tokenStore.getTokenAfter(openBrace);
        var lastToken = tokenStore.getTokenBefore(closeBrace);
